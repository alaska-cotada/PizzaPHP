...
<header>
    <div class="top-bar">
        <nav id="menu" class="pull-right">
            ...
            <li><a href="criarPizza">Criar Lenda</a></li>
            <li><a href="pizzas">The League of Pizza Legends </a></li>
                </b>
...
<div class="section mcb-section dark  " style="padding-top:40px; padding-bottom:0px; background-color:#D32512; 
   ...
   <!--  <img src="img/White and Black Shape Hipster Logo (1).png" style="margin-top: -70px;
    ...
    <div class="column mcb-column one column_fancy_divider ">
		...
		<div class="col-xs-6 no-padding huge-margin-top large-padding-top huge-margin-bottom huge-padding-bottom">

			<div class="col-xs-2">
				<img src="img/cadastro_perfil.png" width alt>
			</div>
...
<div class="col-xs-6 no-padding huge-margin-top large-padding-top huge-margin-bottom huge-padding-bottom">
	<img class="imgCheff" src="img/CheffTF.jpg">
...
<footer id="footerConfi">
    <div class="fancy-divider"> 
    <svg preserveAspectRatio="none" viewBox="0 0 100 102" height="100" width="100%" version="1.1" xmlns="https://www.w3.org/2000/svg" style="background: #3a3f46;">
            ...
            <div class="row">
                <div class="col-sm-3">
                    ...
                    <ul>
                        ...
                        <li><a href="criarPizza">Criar Pizza</a></li>
                    </ul>
                </div>
                ...
                <div class="col-sm-3">
                    <h5>Departamentos</h5>
                    <ul>
                        <li><a href="menu_pizzas">Pizzas</a></li>
                        <li><a href="menu_lanches">Lanches</a></li>
                        <li><a href="menu_sorvetes">Sorvetes</a></li>
                        <li><a href="menu_bebidas">Bebidas</a></li>
                        <li><a href="menu_cervejas">Cervejas</a></li>
                        <li><a href="menu_temperos">Temperos</a></li>
                    </ul>
                </div>
